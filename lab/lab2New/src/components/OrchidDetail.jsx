...
function OrchidDetail() {
  ...
  return (
    <div className="container py-3 py-md-5">
      <div className="card shadow-lg border-0 mx-auto overflow-hidden" style={{ maxWidth: 900 }}>
        <div className="row g-0">
          ...
          <div className="col-12 col-md-5">
            <img
              ...
              style={{ 
                // Trên mobile cao 300px, trên desktop cao 100% của card
                height: "100%", 
                minHeight: "300px",
                maxHeight: "500px",
                objectFit: "cover" 
          ...
          <div className="col-12 col-md-7 d-flex align-items-center">
            <div className="card-body p-4 p-lg-5">
              ...
              <p className="text-muted mb-3 fs-5">
                <span className="fw-bold text-secondary">Category:</span> {orchid.category}
              </p>

              <hr className="my-4 opacity-10" />

              <h3 className="text-success fw-bold mb-4">
                {orchid.price.toLocaleString()} <span className="fs-6">VND</span>
              </h3>

              <div className="mb-4">
                <h6 className="fw-bold text-uppercase small text-muted mb-2">Description</h6>
                <p className="card-text text-secondary" style={{ lineHeight: 1.8, textAlign: "justify" }}>
                  {orchid.description}
                </p>
              </div>
